...
class GreedyBustersAgent(BustersAgent):
    ...
    def chooseAction(self, gameState):
        ...
        for distribution in livingGhostPositionDistributions:
            maxpos=distribution.argMax()
            possible_ghost_position.append(maxpos)

        goal_position=pacmanPosition
        shortest_Distance = float("inf")

        for i in possible_ghost_position:
        ...
        for action in legal:
            ...
            successor_distance = self.distancer.getDistance(successor_position, goal_position)
            if successor_distance < best_dist:
                optimal_action = action
                best_dist= successor_distance
