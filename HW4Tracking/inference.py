...
class ExactInference(InferenceModule):
    ...
    def observe(self, observation, gameState):
        ...
        if noisyDistance==None:
            jailpostion=self.getJailPosition()
            for p in self.legalPositions:
                allPossible[p] = 0
            allPossible[jailpostion]=1
    ...
    def elapseTime(self, gameState):
        ...
        *** GORY DETAIL AHEAD ***
        ...
        for position in self.legalPositions:
            ...
            new_position_distribution=self.getPositionDistribution(self.setGhostPosition(gameState,old_position))

            for new_position, pro in new_position_distribution.items():
                allPossible[new_position]+=pro*self.beliefs[old_position]
        allPossible.normalize()
        self.beliefs = allPossible
