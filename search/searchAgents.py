...
def cornersHeuristic(state, problem):
    ...
    while len(unvisited_corners) !=0:
        for i in range (len(unvisited_corners)):
            dist=util.manhattanDistance(current_position,unvisited_corners[i])
        ...
        current_position=unvisited_corners[corner_num]
        unvisited_corners.remove(unvisited_corners[corner_num])
        min_dist=0
...
def foodHeuristic(state, problem):
    ...
    if len(unvisited_foods)!=0:
        ...
        for i in range (len(unvisited_foods)):
            dist=util.manhattanDistance(current_position,unvisited_foods[i])

            if dist<min_dist or min_dist==0:
                min_dist=dist
                index=i
        nearst_food=unvisited_foods[index]
        unvisited_foods.remove(unvisited_foods[index])
    ...
    if len(unvisited_foods)!=0:
        for i in range (len(unvisited_foods)):
            ...
            if dist>max_dist:
                max_dist=dist
                index=i
        farest_food=unvisited_foods[index]
    if farest_food!=[]:
        cost = util.manhattanDistance(current_position,nearst_food)+util.manhattanDistance(nearst_food,farest_food)
    if farest_food==[] and nearst_food!=[]:
        cost = util.manhattanDistance(current_position,nearst_food)
